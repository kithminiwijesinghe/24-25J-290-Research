...
async def upload_audio(animal_name: str = Form(...), file: UploadFile = File(...)):
    ...
    try:
        ...
        # Compute scoring (WER)
        wer_score = wer(animal_name, predicted_text)

        return {"animal_name": animal_name, "predicted_text": predicted_text, "wer_score": wer_score}
